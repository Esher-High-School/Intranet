...
<div class="row">
	<div class="span4">
		<?php
		echo $this->Form->create('Student', array('inputDefaults' => array('class' => 'span4', 'error' => array('wrap' => 'div', 'class' => 'alert alert-error'))));
		...
		echo $this->Form->input('upn', array('placeholder' => 'UPN', 'label' => false, 'type' => 'text', 'class' => 'uneditable-input span4', 'disabled'));
		echo $this->Form->input('adno', array('placeholder' => 'Admission Number', 'label' => false, 'type' => 'text', 'class' => 'uneditable-input span4', 'disabled'));
	...
	<div class="span3">
		...
		<p style="padding-top: 10px;">UPN</p>
		<p style="padding-top: 10px;">Admission number</p>
		<p style="padding-top: 10px;">School year: For example: 8</p>
		<p style="padding-top: 10px;">Form group: Example 8.AZ</p>
