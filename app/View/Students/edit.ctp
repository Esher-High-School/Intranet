<?php echo $this->Form->create('Student', array('class' => 'form-horizontal', 'inputDefaults' => array('class' => 'form-horizontal', 'error' => array('wrap' => 'div', 'class' => 'inputError')))); ?>
	<div class="form-group">
		<label class="col-md-3 control-label" for="forenameInput">Forename</label>
		<div class="col-md-9">
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="surnameInput">Surname</label>
		<div class="col-md-9">
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="dobInput">
			Date of Birth<br>
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="genderInput">
			Gender<br>
			<small>(example: M or F)</small>
		</label>
		<div class="col-md-9">
			<?php echo $this->Form->input('gender', array('label' => false, 'class' => 'form-control', 'id' => 'sexInput')); ?>
		</div>
	</div>

	<div class="form-group">
		<label class="col-md-3 control-label" for="adnoInput">
			Admission Number<br>
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="upnInput">
			UPN<br>
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="yearInput">
			School Year<br>
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="formInput">
			Tutor Group<br>
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="postcodeInput">
			Postcode
		</label>
		<div class="col-md-9">
	...
	<div class="form-group">
		<label class="col-md-3 control-label" for="onrollInput">
			On Roll<br>
